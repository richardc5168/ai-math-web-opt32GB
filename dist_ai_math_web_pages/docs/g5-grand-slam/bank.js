window.G5_GRAND_SLAM_BANK = [
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：25×10,000。",
      "👉 1 公頃 = 10000 平方公尺。公頃→平方公尺就 ×10000（4 個零）。"
    ],
    "steps": [
      "1 公頃 = 10,000 m²",
      "25×10,000 = 250,000",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 相減時如果分鐘不夠減，從小時借 1（=60 分鐘）。如果小時不夠減，要加 24（跨日）。"
    ],
    "steps": [
      "05:00 → 300 分鐘",
      "減 70 得 230 分鐘",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n判斷小數位：12.5 有 1 位小數。",
      "👉 小數×整數：先忽略小數點算整數乘法，再從積的右邊數回小數位數，放上小數點。"
    ],
    "steps": [
      "小數乘法：12.5×4",
      "計算得 50",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n百分率 = 部分 ÷ 全體，再乘 100%。",
      "Hint 2｜列式/判斷\n列式：12÷80×100。",
      "👉 百分率 = 部分÷全體×100%。先列出部分和全體分別是什麼，再做除法。"
    ],
    "steps": [
      "12÷80 = 15/100",
      "百分率 = 15%"
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 兩個小數相乘：先忽略小數點算整數乘法 → 兩數的小數位數加起來 → 在乘積從右往左數這麼多位放小數點。"
    ],
    "steps": [
      "估算 4.08×1.5 的範圍",
      "計算得 6.12",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：剩下 = 750×(1 − 2/8)。",
      "👉 先算用掉多少（全部×分數），再用全部 − 用掉 = 剩下。注意分數的基準量是「全部」。"
    ],
    "steps": [
      "1 − 2/8 = 3/4",
      "750×3/4 = 562",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：5/8 × ( ? ) = 1，所以 ? = ？？。",
      "👉 倒數 = 分子分母對調。整數 n 的倒數是 1/n。1 的倒數是 1，0 沒有倒數。"
    ],
    "steps": [
      "分子分母交換：5/8 → 8/5",
      "檢查：5/8×8/5 = 1"
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 異分母加法：先通分（找兩個分母的最小公倍數）→ 分子各乘上相應倍數 → 分子相加 → 約分到最簡。"
    ],
    "steps": [
      "lcm(10,8) = 40",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n列式：0.8×1000。",
      "👉 1 公升 = 1000 毫升。公升→毫升乘 1000，毫升→公升除 1000。"
    ],
    "steps": [
      "1 L = 1000 mL",
      "0.8×1000 = 800 mL"
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 分數×分數：分子乘分子、分母乘分母。先交叉約分可以讓數字更小更好算。"
    ],
    "steps": [
      "先交叉約分",
      "(1×5)/(12×9) 約分得 5/108",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 折後價 = 原價 × 折數÷10（或 ×百分比÷100）。驗算：折後 < 原價。"
    ],
    "steps": [
      "付款比例 = 80%",
      "600×80/100 = 480",
    ...
    "common_mistakes": [
      "折扣率和實付率搞反（打 7 折 = 付 70%）。",
      "「打折」以為是減去折數（打 7 折不是減 7）。"
    ]
  },
  {
    "id": "g5gs_alg_add_001",
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n把 +7 移到右邊：兩邊都減 7。",
      "👉 x + a = b → x = b − a。移項後算出 x。驗算：把 x 代回去看等式成立。"
    ],
    "steps": [
      "兩邊同減 7",
      "x = 24 − 7",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 兩個長方體緊貼時，接觸面要從總表面積中扣掉（扣兩次，上下各一面）。"
    ],
    "steps": [
      "兩個正方體表面積 = 432",
      "扣除 2 個接觸面 = 72",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 加完後如果超過 24:00 就跨日。把小時−24，日期+1。分鐘的進位照常處理。"
    ],
    "steps": [
      "22:15 → 1335 分鐘",
      "加 180 得 1515 分鐘",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 找最大公因數(GCD)：列出兩數的因數，找最大的共同因數。或用短除法。"
    ],
    "steps": [
      "最長且不剩 → 求 gcd(48,56)",
      "找 48 和 56 的共同因數",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 時間×倍數：分鐘×倍數→進位到小時（÷60 取商和餘數），小時×倍數 + 進位的小時。"
    ],
    "steps": [
      "每段 15 分鐘 × 5 段",
      "15×5 = 75 分鐘"
  ...
  },
  {
    ...
    "common_mistakes": [
      "把 1 公畝記成 10 或 1000 平方公尺（正確是 100）。",
      "平方公尺和公尺搞混。"
    ]
  },
  {
    ...
    "hints": [
      ...
      "👉 時鐘每小時大格=30°。分針走一格=6°。時針每分鐘走 0.5°。兩針角度相減取絕對值。"
    ],
    "steps": [
      "分針角度 = 30×6 = 180°",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 1 cm³ = 1 mL（體積和容量的橋梁）。直接把 cm³ 的數字當 mL。"
    ],
    "steps": [
      "1 cm³ = 1 mL",
      "1200 cm³ = 1200 mL"
    ...
    "common_mistakes": [
      "以為 cm³ 和 mL 的轉換需要乘以什麼（其實 1cm³=1mL）。",
      "跟公升搞混（1L=1000mL）。"
    ]
  },
  {
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 整數×分數 = 整數×分子÷分母。如果整數能被分母整除，先除再乘更簡單。"
    ],
    "steps": [
      "整數寫成 9/1",
      "9×1 / (1×10) = 9/10",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 從小數點開始往右數位數：第一位是十分位、第二位是百分位、第三位是千分位。"
    ],
    "steps": [
      "百萬位對應位值 1,000,000",
  ...
  },
  {
    ...
    "hints": [
      ...
      "👉 盈虧問題：用(差額)÷(每人多分或少分的量)=人數。再從人數推總量。"
    ],
    "steps": [
      "加4成 = 加40%",
      "500×140/100 = 700",
  ...
  },
  {
    ...
    "hints": [
      "Hint 1｜觀念\n把 x 單獨留下：等式兩邊同除以係數。",
      "Hint 2｜列式/判斷\n兩邊都 ÷4。",
      "👉 移項：把 x 留一邊，數字移另一邊（加→減、乘→除）。算出 x 的值。"
    ],
    "steps": [
      "係數是 4",
      "兩邊同除以 4",
  ...
  },
  {
    ...
    "hints": [
      ...
      "Hint 2｜列式/判斷\n想像『對折』：能對折成功的方向就是對稱軸。",
      "👉 對稱軸是把圖形分成完全重合的兩半的線。正 n 邊形有 n 條對稱軸。"
    ],
    "steps": [
      "想像長方形（非正方形）對折方向",
      "能完全重合的直線有 2 條"
