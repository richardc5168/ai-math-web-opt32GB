...
# ── Auth endpoints extracted to routers/auth.py (EXP-P4-05) ──
from routers.auth import auth_router  # noqa: E402
app.include_router(auth_router)

# ── Learning / analytics endpoints extracted to routers/learning.py (EXP-P4-06) ──
from routers.learning import learning_router  # noqa: E402
