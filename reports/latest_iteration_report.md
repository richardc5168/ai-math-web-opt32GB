...
- `risk_level_zh` (�����I/�������I/�C���I) in students_needing_attention
...
- `level_labels_zh` (���إ�/�o�i��/�ͪ���/�w���/�ݽƲ�) in mastery_distribution
...
- `student_overview`: �ǥͤH�� + ���D�H��
- `attention_summary`: �����I/�������I�H��
- `blocking_summary`: �̤j���뷧�� + ���T�v
- `mastery_summary`: ���Z���������
- `mastery_levels`: �U���ŵ��� (non-zero only)
- `hint_summary_line`: ���ܦ��\�v + �ϥΦ���
- `key_insights`: �e3���}��
- `recommended_actions`: �u������ + ���I�Ʋ� + ���Iĵ��
