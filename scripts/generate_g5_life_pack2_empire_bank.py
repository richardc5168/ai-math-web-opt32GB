...
Output:
    docs/interactive-g5-life-pack2-empire/bank.js
    dist_ai_math_web_pages/docs/interactive-g5-life-pack2-empire/bank.js
...
DOCS_OUT = ROOT / "docs" / "interactive-g5-life-pack2-empire" / "bank.js"
DIST_OUT = ROOT / "dist_ai_math_web_pages" / "docs" / "interactive-g5-life-pack2-empire" / "bank.js"
...
def generate(seed: int) -> List[Dict]:
    ...
    if len(bank) != 200:
        raise RuntimeError(f"Bank size must be 200, got {len(bank)}")
